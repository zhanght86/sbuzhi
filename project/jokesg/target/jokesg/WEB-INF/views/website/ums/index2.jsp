...
<!-- Custom Theme files -->
<link h="${ctx}/ui/website/01/css/style.css" rel='stylesheet' type='text/css' />
 <!-- Custom Theme files -->
		...
		<!-- container -->
			...
			<div id="home" class="header">
				...
				<div class="top-header">
					...
					<div class="logo">
						<h1><a href="${ctx}/ui/website/01/index.html"><span>P</span>唐县第四中学</a></h1>
					</div>
					<div class="navigation-right">
						<span class="menu"><img src="${ctx}/ui/website/01/images/menu.png" alt=" " /></span>
						<nav class="link-effect-3" id="link-effect-3">
							<ul class="nav1 nav nav-wil">
								<li class="active"><a data-hover="Home" href="${ctx}/ui/website/01/index.html">主页</a></li>
								<li><a class="scroll" data-hover="About" href="${ctx}/ui/website/01/#about">About</a></li>
								...
								<li><a class="scroll" data-hover="Contact" href="${ctx}/ui/website/01/#contact">Contact</a></li>
							</ul>
						</nav>
							<!-- script-for-menu -->
								<script>
			...
			<div class="banner-info">
				<div class="col-md-7 header-right">
					...
					<li>
						...
						<li>
							<ul class="address-text">
								<li><b>E-MAIL </b></li>
								<li><a href="${ctx}/ui/website/01/mailto:example@mail.com"> mail@example.com</a></li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>WEBSITE </b></li>
								<li><a href="${ctx}/ui/website/01/http://sc.chinaz.com">www.myresume.com</a></li>
							</ul>
						</li>
				...
				<div class="col-md-5 header-left">
					<img src="${ctx}/ui/website/01/images/wsl02.jpeg" alt="">
				</div>
				<div class="clearfix"> </div>
						...
						<div class="resp-tabs-container">
							<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="col-md-3 team-gd ">
										...
										<a href="${ctx}/ui/website/01/#portfolioModal1" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="${ctx}/ui/website/01/images/pic4.jpg" alt="">
								...
								<div class="col-md-3 team-gd ">
										...
										<a href="${ctx}/ui/website/01/#portfolioModal3" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="${ctx}/ui/website/01/images/pic5.jpg" alt="">
...
<div class="footer" id="contact">
	...
	<div class="service-head one text-center">
			...
			<div class="col-md-6 mail_left">
				<div class="contact-grid1-left">
					<div class="contact-grid1-left1">
						...
						<ul>
							<li>Mail1: <a href="${ctx}/ui/website/01/mailto:info@example.com">info@example1.com</a></li>
							<li>Mail2: <a href="${ctx}/ui/website/01/mailto:info@example.com">info@example2.com</a></li>
						</ul>
					</div>
				</div>
					<div class="contact-grid1-left">
		...
		<div class="copy_right text-center">
			<p>Copyright &copy; 2016.Company name All rights reserved.<a target="_blank" href="${ctx}/ui/website/01/http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
