...
<title>${user.nickname }的个人空间</title>
...
<div class="container_xl">
	<div class="top_section">
		...
		<div class="menu">
			<ul>
				...
				<li><a href="${ctx }/ims/blog/friends.do">朋友圈</a></li>
	...
	<div class="slider_container">
		<div id="slider">
			<img src="${ctx }/ui/blog/images/slide1.jpg" alt="" title="欢迎来到李四哥的个人空间" />
			<img src="${ctx }/ui/blog/images/slide2.jpg" alt="" title="在这里，只有代码" />
			<img src="${ctx }/ui/blog/images/slide3.jpg" alt="" title="乔布斯曾经说过一句话" />
			<img src="${ctx }/ui/blog/images/slide4.jpg" alt="" title="只有疯狂到认为自己能改变世界的人.." />
			<img src="${ctx }/ui/blog/images/slide5.jpg" alt="" title="才能真正改变世界！" />
			<img src="${ctx }/ui/blog/images/slide6.jpg" alt="" title="The people who are crazy enough to think they can change the world are the ones who do." />
		</div>
	</div>
	<!-- 主页五张个性大图 Ends -->
	...
	<div class="main_wrapper">
		<div class="smooth_gradient clearfix">
			<div class="widgets_mainpage_no_frame">
				<a href="#"><img src="${ctx }/ui/blog/images/featured1.png" alt="" /></a>
				<h2>基本信息</h2>
				<p>账号：${user.username }</p>
				<p>昵称：${user.nickname }</p>
				<p>邮箱：${user.email }</p>
				<p>所属企业：</p>
				<p>个人说明：${user.remarks }</p>
			</div>
			<div class="widgets_mainpage_no_frame">
				<a href="#"><img src="${ctx }/ui/blog/images/featured2.png" alt="" /></a>
				<h2>个人信息1</h2>
				<p>姓名：${info.name }</p>
				<p>电话：${info.telPhone }</p>
				<p>性别：${info.sex }</p>
				<p>年龄：${info.age }</p>
				<p>故乡：${info.hometown }</p>
			</div>
			<div class="widgets_mainpage_no_frame">
				<a href="#"><img src="${ctx }/ui/blog/images/featured1.png" alt="" /></a>
				<h2>个人信息2</h2>
				...
				<p>星座：${info.zodiac }</p>
				<p>生肖：${info.twelveZodiac }</p>
				<p>职业：${info.profession }</p>
				<p>学校：${info.school }</p>
				<div class="read_more_button"><a href="#">修改</a></div>
			</div>
		</div>
