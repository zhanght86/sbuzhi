package com.jokesg.gg.components.sql;
...
public class GenerateSql {
	...
	public Dispatch getCell(int cellRow, int cellColumn) {
		return Dispatch.call(table, "Cell", new Variant(cellRow),
	...
	public void saveDocAndExit(File fileName, boolean isSave) throws Exception {
		if (fileName != null) {
			...
			Dispatch wordBasic = (Dispatch) Dispatch.call(word, "WordBasic")
					.getDispatch();
			Dispatch.invoke(wordBasic, "FileSaveAs", Dispatch.Method,
					new Object[] { fileName.getPath(), new Variant(true),
